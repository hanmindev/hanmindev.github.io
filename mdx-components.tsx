...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h3: ({ children }) => <h3 className="text-2xl font-semibold mt-8">{children}</h3>,
    h4: ({ children }) => <h4 className="text-xl font-semibold mt-8">{children}</h4>,
    h5: ({ children }) => <h5 className="text-lg font-semibold mt-8">{children}</h5>,
    h6: ({ children }) => <h6 className="text-base font-semibold mt-8">{children}</h6>,
    p: ({ children }) => <p className="text-sm mt-2">{children}</p>,
    a: ({ children, href }) => <ExternalLink className="text-sm" href={href}>{children}</ExternalLink>,
