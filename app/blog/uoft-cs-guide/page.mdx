...
If you want to contribute, leave a comment below in [Discussion](#discussion), open a pull request on the [GitHub repository](https://github.com/hanmindev/hanmindev.github.io), or email me through the contact on the bottom right of the page. Feel free to ask questions as well if you think something was unclear, or didn't cover it; I'm sure many others might be wondering the same thing you are.
