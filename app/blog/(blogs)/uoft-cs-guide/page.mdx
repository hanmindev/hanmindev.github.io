...
**What can you do at this point?**: There might be a way to salvage this situation. Apparently it is possible to enrol in courses during the second sub session for the summer even after the summer registration deadline, so if you get permission to do that, enrol in 1.5 credits in order to get the full-time student status. [Source: reddit](https://www.reddit.com/r/UofT/comments/1d0ixa1/is_it_too_late_to_enroll_in_the_summer_second_sub/). This *could* work if you are in this situation already, but I wouldn't plan your schedule with using this in mind. Otherwise, unless you can somehow find some visa that will let you do the internship (I don't know much about other visas but, I'm going to say this is impossible unless you literally have 2000iq), you will not be able to do the fall internship in the United States. However, if your company allows you to, you may be able to either do the internship in their Canadian office (assuming they even have one), or ask to push the internship to another time, like winter. This can be quite risky depending on the company, so it's best to not let it get to this point.
