...
**[4. Things to Know](#things-to-know)**
  ...
  * [4.4. TLI - Technology Leadership Initiative](##tli-technology-leadership-initiative)
    * [4.4.1. Modified CSC207](###modified-csc207)
    * [4.4.2. Workshops](###workshops)
    * [4.4.3. Application Process](###application-process)
  * [4.5. J-1 Visa Considerations](##j-1-visa-considerations)
    * [4.5.1. Some examples to better illustrate the situation](###some-examples-to-better-illustrate-the-situation)
...
**[6. Applying for Internships](#applying-for-internships)**
  ...
  * [6.2. Internship Search](##internship-search)
    ...
    * [6.2.2. Online Assessments / Take Home Assessments](###online-assessments-take-home-assessments)
...
Useful resource for looking up tuition fees: [link](https://www.google.com/url?q=https://planningandbudget.utoronto.ca/tuition-fee-lookup-tool/&sa=D&source=docs&ust=1714755439395501&usg=AOvVaw0MO6Dzu9yLdq5NyD9XNWLY)
...
Even if you are a Canadian Citizen or a Permanent Residents, this can still be important! Since you are a student at UofT (even for international students I believe), you can be eligible for the J-1 visa, which you will need if you want to intern in the United States! Read more in [J-1 Visa Considerations](##j-1-visa-considerations).
...
**What can you do at this point?**: There might be a way to salvage this situation. Apparently it is possible to enrol in courses during the second sub session for the summer even after the summer registration deadline, so if you get permission to do that, enrol in 1.5 credits in order to get the full-time student status. [Source: reddit](https://www.reddit.com/r/UofT/comments/1d0ixa1/is_it_too_late_to_enroll_in_the_summer_second_sub/). This *could* work if you are in this situation already, but I wouldn't plan your schedule with using this in mind. Otherwise, unless you can somehow find some visa that will let you do the internship (which honestly is very unlikely), you will not be able to do the fall internship in the United States. However, if your company allows you to, you may be able to either do the internship in their Canadian office (assuming they even have one), or ask to push the internship to another time, like winter. This can be quite risky depending on the company, so it's best to not let it get to this point.
...
You can find any part-time jobs on [clnx](https://clnx.utoronto.ca/home.htm). I've heard that work-study jobs can be very flexible and there are many opportunities (e.g. tons of development roles with startups with the Hatchery). I'm sure there are ones you can find externally as well, although they seem to be more rare.
...
**[CSC317](https://github.com/alecjacobson/computer-graphics-csc317) - Computer Graphics**
...
Stanford University has TreeHacks in April. **They reimburse flights**. It’s even bigger than Hack the North. It’s in California. It’s Stanford. Need I say more?
Here’s a (somewhat comprehensive list of) hackathons in Canada (with a focus on Ontario Hackathons) with a few in the US. Most of these often have buses / travel reimbursements:
* NWHacks at UBC (BC)
...
[This Discord server](https://discord.gg/4spyAW4H43) is dedicated to the Canadian / Ontario hackathon community, and they have a bunch of resources set up to keep track of new hackathons, make teams, and more.
...
[Advice on CS Research](https://alstonlo.github.io/blog/advice-on-cs-research/), written by Alston Lo. If you're interested in grad school and research, this is a must-read!
